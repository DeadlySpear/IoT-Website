...
function Checkbox({
  ...
  return (
    <CheckboxPrimitive.Root
      data-slot="checkbox"
      className={cn(
        "peer bg-card/50 border-muted-foreground/50 size-5 shrink-0 rounded-[4px] border-2 shadow-xs transition-[background-color,border-color,box-shadow] outline-none disabled:cursor-not-allowed disabled:opacity-50",
